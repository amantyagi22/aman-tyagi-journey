        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10 items-center">
          <div className="md:col-span-8 staggered-fade-in">
            ...
            <div className="flex flex-wrap gap-4 mt-8">
              <Button size="lg" className="btn-animated bg-white text-indigo-700 hover:bg-white/90" asChild>
                <a href="#contact">
                  Get in Touch
                  <ArrowRight size={18} />
                </a>
              </Button>
              <Button variant="outline" size="lg" className="btn-animated border-white/20 text-white hover:bg-white/10" asChild>
                <a href="#experience">
