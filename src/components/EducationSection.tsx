    ...
    <section id="education" className="py-24 bg-gray-50 relative">
      ...
      <div className="container relative z-10">
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl font-bold tracking-tight mb-4 text-gradient">Education</h2>
            ...
            <CardContent className="p-0">
              <div className="md:flex">
                <div className="md:w-1/3 bg-gradient-to-br from-indigo-500 to-blue-600 text-white p-8">
                  ...
                  <p className="text-blue-100">Computer Science and Engineering</p>
                ...
                <div className="md:w-2/3 p-8">
                  ...
                  <div>
                    <h4 className="text-lg font-medium mb-3 text-gray-700">Relevant Coursework:</h4>
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                      <div className="flex items-center p-3 bg-gray-100 rounded-lg">
                        <span className="w-2 h-2 bg-indigo-500 rounded-full mr-3"></span>
                        <span className="text-gray-800 text-sm">Data Structures & Algorithms</span>
                      </div>
                      <div className="flex items-center p-3 bg-gray-100 rounded-lg">
                        <span className="w-2 h-2 bg-blue-500 rounded-full mr-3"></span>
                        <span className="text-gray-800 text-sm">Operating Systems</span>
                      </div>
                      <div className="flex items-center p-3 bg-gray-100 rounded-lg">
                        <span className="w-2 h-2 bg-purple-500 rounded-full mr-3"></span>
                        <span className="text-gray-800 text-sm">Software Engineering</span>
                      </div>
                      <div className="flex items-center p-3 bg-gray-100 rounded-lg">
                        <span className="w-2 h-2 bg-green-500 rounded-full mr-3"></span>
                        <span className="text-gray-800 text-sm">Computer Networks</span>
                      </div>
                      <div className="flex items-center p-3 bg-gray-100 rounded-lg">
                        <span className="w-2 h-2 bg-pink-500 rounded-full mr-3"></span>
                        <span className="text-gray-800 text-sm">Cloud Computing</span>
                      </div>
                      <div className="flex items-center p-3 bg-gray-100 rounded-lg">
                        <span className="w-2 h-2 bg-yellow-500 rounded-full mr-3"></span>
                        <span className="text-gray-800 text-sm">DBMS & NoSQL</span>
                      </div>
                    </div>
                    
                    <p className="mt-6 text-gray-600">
                      Gained comprehensive knowledge in computer science fundamentals, advanced programming concepts, and software design principles. Participated in various technical projects and hackathons.
                    </p>
                  </div>
                </div>
              </div>
