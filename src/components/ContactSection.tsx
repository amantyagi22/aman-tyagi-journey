          ...
          <CardContent className="p-0">
            <div className="grid grid-cols-1 md:grid-cols-12 gap-0">
              <div className="md:col-span-5 bg-gradient-to-br from-blue-600 to-indigo-700 text-white p-8 animate-fade-in">
                <h3 className="text-2xl font-bold mb-8 pb-2 border-b border-white/20">
                  Contact Information
                </h3>
              ...
              <div
                className="md:col-span-7 p-8 animate-fade-in"
                style={{ animationDelay: "0.2s" }}
              >
                <h3 className="text-2xl font-bold mb-8 pb-2 border-b border-gray-100">
                  Send Me a Message
                </h3>
                ...
                <form className="space-y-6">
                  ...
                  <Button
                    type="submit"
                    size="lg"
                    className="w-full btn-animated bg-gradient-to-r from-blue-600 to-indigo-600"
                  >
